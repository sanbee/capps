...
void		gtk_plot_point_get_pixel	(GtkPlot *plot,
                                                 GtkPlotPoint point,
                                                 gint *x, gint *y);
void            gtk_plot_pixel_get_point        (GtkPlot *plot,
                                                 gint x, gint y,
                                                 GtkPlotPoint *point);
...
void 		gtk_plot_dataset_set_points	(GtkPlotData *data,
						 GtkPlotPoint *points,
                                                 gint num_points);
GtkPlotPoint * 	gtk_plot_dataset_get_points	(GtkPlotData *data, 
                                                 gint *num_points);
