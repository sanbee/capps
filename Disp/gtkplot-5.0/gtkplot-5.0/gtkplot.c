...
void
gtk_plot_axis_set_visible (GtkPlot *plot, gint axis, gboolean visible)
{
  GtkPlotAxis *aux;
...
gboolean
gtk_plot_axis_get_visible (GtkPlot *plot, gint axis)
{
  GtkPlotAxis *aux;
...
void
gtk_plot_axis_move_title (GtkPlot *plot, gint axis, gint angle, gdouble x, gdouble y)
{
  GtkPlotAxis *aux;
...
void 
gtk_plot_set_x0_visible(GtkPlot *plot, gboolean visible)
{
...
gboolean 
gtk_plot_get_x0_visible(GtkPlot *plot)
{
  return plot->show_x0;
}

void 
gtk_plot_set_y0_visible(GtkPlot *plot, gboolean visible)
{
...
gboolean 
gtk_plot_get_y0_visible(GtkPlot *plot)
{
  return plot->show_y0;
}

void 
gtk_plot_set_grids_visible(GtkPlot *plot, 
...
void 
gtk_plot_get_grids_visible(GtkPlot *plot, 
                           gboolean *vmajor, gboolean *vminor,
                           gboolean *hmajor, gboolean *hminor)
{
