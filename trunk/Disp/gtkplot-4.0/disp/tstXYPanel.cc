...
main(int argc, char **argv)
{
  ...
  Form = OnDisp[0].Make(Form,5,5,470,470,600,300);//,argc,argv,"PlotTool");
  
  OnDisp[0].AddXData(&X[0],100);
  OnDisp[0].AddYData(&X[0],100);
  OnDisp[0].Plot();//X,Y,100);

  //  OnDisp[0].GetRange(&Range[0],1);
