...
int main(int argc, char **argv)
{
 ...
 RENTER:// UI re-entry point.
  ...
  UI(restartUI,argc, argv, MSName, timeStr, spwStr, antStr, fieldStr, paInc, 
     ...
     operation,pblimit,cycleFactor,applyOffsets,dopbcorr,interactive);
...
//       ROMSFieldColumns msfield(selectedMS.field());
//       cout << "phase center = " << msfield.phaseDirMeas(0) << endl;
//       mphaseCenter = msfield.phaseDirMeas(0);
      ...
      if (operation=="clean")
	{
	  ...
	  if (interactive)
		...
		throw(AipsError("No residual image name found.  "
