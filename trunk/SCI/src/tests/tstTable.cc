  ...
  try
    {
      ...
      //
      // slicerLength(0) is the number of polarizations.
      // slicerLength(1) is the number of frequency channels.
      //
      slicerStart     = 0;      slicerStart(1)  = 0;  //slicerStart(1)  = 100;
      slicerLength(0) = polLen; slicerLength(1) = 63; //slicerLength(1) = 300;
