...
c$$$               if (dopointingcorrection .eq. 1) then
c$$$                  griduvw(1)=(iloc(1)-convOrigin)/(scale(1)*sampling)
c$$$                  griduvw(2)=(iloc(2)-convOrigin)/(scale(2)*sampling)
c$$$                  ra1 = raoff(ant1(irow)+1)
c$$$                  ra2 = raoff(ant2(irow)+1)
c$$$                  dec1= decoff(ant1(irow)+1)
c$$$                  dec2= decoff(ant2(irow)+1)
c$$$                  call gfeij(griduvw,area,ra1,dec1,ra2,dec2,dograd,
c$$$     $                 pcwt,pdcwt1,pdcwt2,currentCFPA)
c$$$c$$$                  call gcppeij(griduvw,area,ra1,dec1,ra2,dec2,dograd,
c$$$c$$$     $                 pcwt,pdcwt1,pdcwt2,currentCFPA)
c$$$               else 
c$$$                  pcwt=cmplx(1.0,0.0)
c$$$               endif
               if(uvw(3,irow).gt.0.0) then
                  cwt=conjg(func(iloc(1),iloc(2), iloc(3),
     $                 ConjPlane))
